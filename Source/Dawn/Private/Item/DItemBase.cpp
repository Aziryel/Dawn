...
#include "Item/DItemBase.h"
#include "AbilitySystemBlueprintLibrary.h"
#include "AbilitySystemComponent.h"

ADItemBase::ADItemBase()
{
...
void ADItemBase::BeginPlay()
{
	Super::BeginPlay();
	
}

void ADItemBase::ApplyEffectToTarget(AActor* TargetActor, TSubclassOf<UGameplayEffect> GameplayEffectClass)
{
...
void ADItemBase::OnOverlap(AActor* TargetActor)
{
...
void ADItemBase::OnEndOverlap(AActor* TargetActor)
{
