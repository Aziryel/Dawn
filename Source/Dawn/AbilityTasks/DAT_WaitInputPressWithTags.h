...
#include "DAT_WaitInputPressWithTags.generated.h"
 ...
 */
UCLASS()
class DAWN_API UDAT_WaitInputPressWithTags : public UAbilityTask
{
	...
	*/
	...
	static UDAT_WaitInputPressWithTags* WaitInputPressWithTags(UGameplayAbility* OwningAbility, FGameplayTagContainer RequiredTags, FGameplayTagContainer IgnoredTags, bool bTestAlreadyPressed = false);
